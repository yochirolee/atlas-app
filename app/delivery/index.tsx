...
export default function Delivery() {
  ...
  const refreshData = useCallback(async () => {
    const [allStops, newStats, onlineStatus] = await Promise.all([
      getAllStops(),
      getStopStats(),
      isOnline(),
    ]);
    ...
    return (
      <View style={[styles.permWrap, { paddingTop: insets.top }]}>
        ...
        <View style={styles.permContent}>
          ...
          <TouchableOpacity style={[styles.permBtn, { backgroundColor: Colors.primary }]} onPress={handleRequestAllPermissions}>
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.topBar, { paddingTop: insets.top + 8 }]}>
        <BlurView intensity={50} tint="dark" style={styles.topBarBlur}>
        ...
        <BlurView intensity={60} tint="dark" style={styles.bottomBlur}>
          ...
          <View style={styles.topInfoRow}>
            ...
            <View style={styles.batchCountRow}>
              <View style={[styles.batchCountBadge, { backgroundColor: batchIds.length > 0 ? 'rgba(255,255,255,0.15)' : 'rgba(255,255,255,0.05)' }]}>
                <Ionicons name="cube" size={14} color={batchIds.length > 0 ? '#FFFFFF' : 'rgba(255,255,255,0.4)'} />
                <Text style={[styles.batchCountText, { color: batchIds.length > 0 ? '#FFFFFF' : 'rgba(255,255,255,0.4)' }]}>
          ...
          <View style={styles.proofActionRow}>
            <TouchableOpacity 
              ...
              onPress={() => router.push({ pathname: '/delivery/proof', params: { ids: JSON.stringify(batchIds) } })}
          ...
          {lastScanned && (
            <View style={styles.lastScanRow}>
              ...
              <Text style={[styles.lastScanText, { color: Colors.green }]} numberOfLines={1}>{lastScanned}</Text>
            </View>
          )}
              ...
              {isSyncing ? (
                ...
                <>
                  ...
                  <Text style={styles.syncTriggerBtnText}>
                    {stats.error > 0 ? `Retry ${stats.error} Failed Stops` : `Sync ${stats.pending} Pending Stops`}
                  </Text>
                </>
              )}
            </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  locHintWrap: {
    ...
    backgroundColor: 'rgba(245,158,11,0.15)', paddingHorizontal: 20, paddingVertical: 12,
  ...
  confirmInner: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10, paddingVertical: 16, backgroundColor: '#FFFFFF', borderRadius: 999 },
  confirmBtnText: { color: '#000000', fontSize: 16, fontWeight: '700' },
  batchCountRow: { alignItems: 'center', marginBottom: 4 },
  batchCountBadge: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 16, paddingVertical: 8, borderRadius: Radius.full },
  ...
  lastScanRow: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: 'rgba(16,185,129,0.1)', borderRadius: Radius.md, padding: 10 },
  ...
  listBtn: {
    ...
    gap: 6, backgroundColor: 'rgba(255,255,255,0.08)', borderRadius: Radius.lg,
    paddingVertical: 16, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)',
  },
  ...
  /* permission */
  permWrap: { flex: 1, backgroundColor: Colors.bg, alignItems: 'center', justifyContent: 'center' },
  ...
  permTitle: { fontSize: 24, fontWeight: '700' },
  permSub: { fontSize: 15, textAlign: 'center', lineHeight: 24 },
  permBtn: { paddingHorizontal: 40, paddingVertical: 16, borderRadius: 999, marginTop: 8 },
